  ...
  return (
    <section ref={sectionRef} className="relative py-24 md:py-32 bg-[#F5F5F7] overflow-hidden">
      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12 relative min-h-[600px] md:h-[1000px]">
        ...
        >
            <div className="aspect-[3/4] w-full h-full overflow-hidden reveal-on-scroll shadow-2xl lg:cursor-none rounded-sm">
                <img 
        ...
        >
             <div className="aspect-square w-full h-full overflow-hidden shadow-2xl reveal-on-scroll delay-200 lg:cursor-none rounded-sm">
                <img 
