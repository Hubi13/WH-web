    ...
    <section className="relative h-[100dvh] w-full bg-black text-white overflow-hidden" aria-label="Introduction">
      ...
      <div className="absolute inset-0 z-20 flex flex-col justify-center items-center text-center px-4 md:px-12 pointer-events-none">
          ...
          <div className="max-w-[1920px] w-full mx-auto flex flex-col items-center pointer-events-auto">
              ...
              <div className={`
                  inline-flex items-center gap-3 px-3 py-1.5 md:px-4 md:py-2 border border-white/20 rounded-full bg-white/5 backdrop-blur-md mb-6 md:mb-12 
              ...
              <h1 className={`
                  font-display font-light leading-[1] md:leading-[0.95] tracking-tight mb-6 md:mb-12
                  text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl 2xl:text-[10rem]
                  transition-all duration-1000 delay-200 transform text-white
                  ${loaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}
              `}>
                  <span className="block">{t.hero.titleLine1}</span>
                  <span className="text-white/70 font-medium italic font-serif block mt-1 md:mt-2">{t.hero.titleLine2}</span>
              </h1>

              <p className={`
                  text-sm sm:text-base md:text-xl text-gray-300 font-light leading-relaxed max-w-xs sm:max-w-md md:max-w-2xl mb-8 md:mb-12
