...
const ModelSelector: React.FC = () => {
  ...
  return (
    <section id="models" className="py-20 md:py-32 bg-[#F5F5F7] relative" aria-labelledby="collection-heading">
      <div className="max-w-[1800px] mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-16">
             <div className="mb-8 md:mb-0">
                ...
                <h2 id="collection-heading" className="font-sans text-3xl md:text-6xl text-[#1D1D1F] font-light tracking-tight">
             ...
             <div className="w-full md:w-auto overflow-x-auto hide-scrollbar">
               <div className="flex gap-2 bg-white p-1.5 rounded-full border border-gray-200 shadow-sm w-max" role="tablist" aria-label="House Models">
                  ...
                  <button
                      ...
                      className={`
                      px-5 md:px-6 py-2.5 md:py-3 rounded-full text-[10px] md:text-xs font-bold uppercase tracking-[0.1em] transition-all duration-300 whitespace-nowrap
                      ${activeIndex === idx 
        ...
        >
            ...
            >
                <div>
                    <h3 className="text-3xl md:text-5xl font-light text-[#1D1D1F] mb-3 md:mb-4 tracking-tight">{activeModel.name}</h3>
                    <p className="text-[#6E6E73] text-base md:text-lg font-light leading-relaxed border-l-2 border-[#1D1D1F]/10 pl-5 md:pl-6">
                        {details.tagline}
                    </p>
                </div>
                
                <div className="space-y-4 md:space-y-6 py-6 md:py-8 border-t border-gray-200">
                ...
                <a 
                  ...
                  className="w-full py-4 md:py-5 bg-[#1D1D1F] text-white rounded-xl flex items-center justify-center gap-3 md:gap-4 hover:bg-[#000] hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl shadow-[#1D1D1F]/20 no-underline"
                >
