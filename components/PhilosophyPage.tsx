...
const PhilosophyPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#E5E5E5] text-[#1D1D1F] pt-32 pb-12">
                        ...
                        <div className="sticky top-32 space-y-2">
                            {navItems.map((item) => (
                                <button
                                    ...
                                    className={`w-full flex items-center gap-4 p-4 rounded-xl text-left transition-all duration-300 ${activeTab === item.id
