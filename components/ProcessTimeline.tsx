...
const ProcessTimeline: React.FC = () => {
  ...
  return (
    <section ref={containerRef} id="process" className="py-32 md:py-40 bg-[#050505] text-white relative overflow-hidden">
                 ...
                 {LIFECYCLE_STEPS.map((step, index) => {
                     ...
                     return (
                         ...
                         >
                             ...
                             `}>
                                 <div className={`
                                    bg-[#0A0A0A] border p-8 md:p-12 relative overflow-hidden transition-all duration-500 rounded-3xl
                                    ${isActive ? 'border-white/40 shadow-[0_0_30px_rgba(255,255,255,0.05)]' : 'border-white/20'}
                                 `}>
                                     
                                     {/* Big Background Number */}
                                     <div className={`
                                        absolute -bottom-8 font-display font-bold text-[120px] md:text-[180px] leading-none select-none pointer-events-none transition-colors duration-1000
